...
def initialise(splitt,splitz,lowz,highz,timesplit,timesplitf,alpha, beta, gamma,Q3,Q5, Length, Time, winding0, winding1, a, b, c):
    ...
    return(alpha, beta, gamma,Q3,Q5)

def redefine(splitt,splitz,lowz,highz,timesplit,timesplitf,alpha, beta, gamma,Q3,Q5, Length, Time, winding0, winding1, a, b, c):
